...
- Modo online por turnos: "Jugar online" desde Inicio, sala por codigo de 5 caracteres, cada jugador arma su equipo en su propio celular y despues juega su turno cuando puede. Si el rival cierra la sala o se sale (antes o durante el partido), se avisa y se vuelve solo al menu en vez de dejarte mirando una partida congelada. Probado de punta a punta con una simulacion (dos celulares "de mentira" en vez de Firestore real, ver "Proximos pasos sugeridos") que encontro y corrigio dos fallas que lo rompian del todo, y despues verifico un turno completo de verdad (tiro real con arrastre) yendo y viniendo entre los dos lados; falta la prueba con dos celulares y cuentas reales.
