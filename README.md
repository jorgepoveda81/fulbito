...
- Modo online por turnos: "Jugar online" desde Inicio, sala por codigo de 5 caracteres, cada jugador arma su equipo en su propio celular y despues juega su turno cuando puede. Si el rival cierra la sala o se sale (antes o durante el partido), se avisa y se vuelve solo al menu en vez de dejarte mirando una partida congelada (ver "Proximos pasos sugeridos" — necesita probarse con dos celulares reales).
